...
package name.martingeisse.serverblob.util.codemirror.compile;
...
import name.martingeisse.serverblob.util.WicketHeadUtil;
import name.martingeisse.serverblob.util.codemirror.CodeMirrorBehavior;
import name.martingeisse.serverblob.util.javascript.JavascriptAssemblerUtil;
...
public class CodeMirrorAutocompileBehavior extends AbstractDefaultAjaxBehavior {
	 ...
	 * the resultConsumer
	 */
	private Consumer<CompilerResult> resultConsumer;
	 ...
	 */
	public Consumer<CompilerResult> getResultConsumer() {
	 ...
	 * @return this
	 */
	public CodeMirrorAutocompileBehavior setResultConsumer(Consumer<CompilerResult> resultConsumer) {
